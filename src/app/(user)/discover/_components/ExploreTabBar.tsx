...
export function ExploreTabBar({ isLoggedIn = false }: { isLoggedIn?: boolean }) {
  ...
  return (
    <>
    <div className="fixed bottom-[var(--bottom-nav-space)] left-0 right-0 z-30 pointer-events-none">
      <div className="max-w-[540px] mx-auto relative flex justify-center items-center">
